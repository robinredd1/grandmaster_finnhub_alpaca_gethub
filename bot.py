...
if not ALPACA_API_SECRET: missing.append("ALPACA_API_SECRET")
if missing:
    print("[FATAL] Missing environment variables:", ", ".join(missing))
    print("See README.md → Set Secrets in Replit.")
    sys.exit(1)
...
async def main():
    print("=== Grandmaster Finnhub (data) + Alpaca Paper (orders) — GitHub Edition ===")
